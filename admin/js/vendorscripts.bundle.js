            ...
            slimScroll: function (b) {
                ...
                return this.each(function () {
                    ...
                    function e(a, b, c) {
                        ...
                        if (b && (e = parseInt(z.css("top")) + a * parseInt(d.wheelStep) / 100 * z.outerHeight(),
                    ...
                    function h() {
                        d.alwaysVisible || (l = setTimeout(function () {
                            d.disableFadeOut && i || j || k || (z.fadeOut("slow"),
                                y.fadeOut("slow"))
                        }, 1e3))
                    }
                    ...
                    if (u.parent().hasClass(d.wrapperClass)) {
                        ...
                        y.css(A),
                            ...
                            u.bind("touchmove", function (a) {
                                if (s || a.originalEvent.preventDefault(),
                            ...
                            "bottom" === d.start ? (z.css({
                                ...
                                e(0, !0)) : "top" !== d.start && (e(a(d.start).position().top, null, !0),
                                    d.alwaysVisible || z.hide()),
                            function (a) {
                                window.addEventListener ? (a.addEventListener("DOMMouseScroll", c, !1),
                                    a.addEventListener("mousewheel", c, !1)) : document.attachEvent("onmousewheel", c)
                            }(this)
                    }
                }),
                    this
            ...
            d = function () {
                ...
                e = function () {
                    ...
                    return a = function () {
                        ...
                        ,
                        arguments.length > 1 ? (arguments[0] ? (a.prototype = c.extend(new arguments[0], arguments[arguments.length - 1]),
                            ...
                            arguments.length > 2 && (b = Array.prototype.slice.call(arguments, 1, -1),
                                ...
                                c.extend.apply(c, b))) : a.prototype = arguments[0],
                        a.prototype.cls = a,
                        a
                }
                ,
                    ...
                    render: function (a, b, c) {
                        ...
                        return this.format.replace(this.fre, function () {
                            ...
                            return e = arguments[1],
                                ...
                                d ? (h = d[2],
                                    e = d[1]) : h = !1,
                                void 0 === (g = j[e]) ? "" : f && b && b[f] ? (a = b[f],
                                    a.get ? b[f].get(g) || g : b[f][g] || g) : (l(g) && (g = c.get("numberFormatter") ? c.get("numberFormatter")(g) : p(g, h, c.get("numberDigitGroupCount"), c.get("numberDigitGroupSep"), c.get("numberDecimalMark"))),
                                        g)
                        })
                    }
                }),
                ...
                p = function (a, b, d, e, f) {
                    var g, h;
                    for (a = (!1 === b ? parseFloat(a).toString() : a.toFixed(b)).split(""),
                ...
                n = function (b) {
                    ...
                    c = a.createElement("style"),
                        ...
                        d ? a.styleSheets[a.styleSheets.length - 1].cssText = b : c["string" == typeof a.body.style.WebkitAppearance ? "innerText" : "innerHTML"] = b
                }
                ,
                c.fn.simpledraw = function (b, d, e, f) {
                    var g, h;
                    if (e && (g = this.data("_jqs_vcanvas")))
                        return g;
                    if (!1 === c.fn.sparkline.canvas)
                        return !1;
                    if (void 0 === c.fn.sparkline.canvas) {
                        ...
                        if (i.getContext && i.getContext("2d"))
                            ...
                            if (!a.namespaces || a.namespaces.v)
                                return c.fn.sparkline.canvas = !1,
                                    !1;
                ...
                r = e({
                    ...
                    updateDisplay: function () {
                        var a, b, d, e, f, g = this.splist, h = g.length, i = !1, j = this.$canvas.offset(), k = this.currentPageX - j.left, l = this.currentPageY - j.top;
                        if (this.over) {
                            for (d = 0; d < h; d++)
                                b = g[d],
                                    (e = b.setRegionHighlight(this.currentEl, k, l)) && (i = !0);
                            if (i) {
                                if (f = c.Event("sparklineRegionChange"),
                ...
                s = e({
                    ...
                    init: function (b) {
                        ...
                        this.container = b.get("tooltipContainer") || a.body,
                            ...
                            c(window).bind("resize.jqs scroll.jqs", c.proxy(this.updateWindowDims, this)),
                ...
                c.fn.sparkline = function (b, d) {
                    return this.each(function () {
                        ...
                        if (e = function () {
                            var d, e, f, i, j, k, l;
                            if ("html" === b || void 0 === b ? (l = this.getAttribute(g.get("tagValuesAttribute")),
                                void 0 !== l && null !== l || (l = h.html()),
                                d = l.replace(/(^\s*<!--)|(-->\s*$)|\s+/g, "").split(",")) : d = b,
                                e = "auto" === g.get("width") ? d.length * g.get("defaultPixelsPerValue") : g.get("width"),
                                "auto" === g.get("height") ? g.get("composite") && c.data(this, "_jqs_vcanvas") || (i = a.createElement("span"),
                                    i.innerHTML = "a",
                                    h.html(i),
                                    f = c(i).innerHeight() || c(i).height(),
                                    c(i).remove(),
                                    i = null) : f = g.get("height"),
                                g.get("disableInteraction") ? j = !1 : (j = c.data(this, "_jqs_mhandler"),
                                    j ? g.get("composite") || j.reset() : (j = new r(this, g),
                                        c.data(this, "_jqs_mhandler", j))),
                                g.get("composite") && !c.data(this, "_jqs_vcanvas"))
                                return void (c.data(this, "_jqs_errnotify") || (alert("Attempted to attach a composite sparkline to an element with no existing sparkline"),
                ...
                c.sparkline_display_visible = function () {
                    ...
                    for (b = 0,
                        d = H.length; b < d; b++)
                        a = H[b][0],
                            c(a).is(":visible") && !c(a).parents().is(":hidden") ? (H[b][1].call(a),
                                c.data(H[b][0], "_jqs_pending", !1),
                                e.push(b)) : c(a).closest("html").length || c.data(a, "_jqs_pending") || (c.data(H[b][0], "_jqs_pending", !1),
                                    e.push(b));
                    for (b = e.length; b; b--)
                        H.splice(e[b - 1], 1)
                }
                    ...
                    getTagSetting: function (a) {
                        ...
                        if (this.tagValCache.hasOwnProperty(a))
                            ...
                            if (void 0 === (b = this.tag.getAttribute(f + a)) || null === b)
                                ...
                                for (d = b.substr(1, b.length - 2).split(","),
                                    b = {},
                                    c = d.length; c--;)
                                    e = d[c].split(":", 2),
                                        b[e[0].replace(/(^\s*)|(\s*$)/g, "")] = i(e[1].replace(/(^\s*)|(\s*$)/g, ""));
                            else
                                b = i(b);
                ...
                c.fn.sparkline._base = e({
                    ...
                    setRegionHighlight: function (a, b, c) {
                        ...
                        return b > this.canvasWidth || c > this.canvasHeight || b < 0 || c < 0 ? null : (d = this.getRegion(a, b, c),
                            e !== d && (void 0 !== e && f && this.removeHighlight(),
                                this.currentRegion = d,
                                void 0 !== d && f && this.renderHighlight(),
                                !0))
                    },
                    clearRegionHighlight: function () {
                        return void 0 !== this.currentRegion && (this.removeHighlight(),
                            this.currentRegion = void 0,
                            !0)
                    },
                    ...
                    getCurrentRegionTooltip: function () {
                        ...
                        for (d = b.length,
                            ...
                            for (n = b[h],
                                ...
                                e = n.fclass || "jqsfield",
                                p = 0; p < o; p++)
                                a[p].isNull && q.get("tooltipSkipNull") || (c.extend(a[p], {
                ...
                t = {
                    changeHighlight: function (a) {
                        ...
                        f && (b = this.renderRegion(d, a),
                            c.isArray(b) || c.isArray(f) ? (e.replaceWithShapes(f, b),
                ...
                c.fn.sparkline.line = u = e(c.fn.sparkline._base, {
                    ...
                    renderHighlight: function () {
                        ...
                        e && (g && h && (a = d.drawCircle(e[0], e[1], g, void 0, h),
                            this.highlightSpotId = a.id,
                            d.insertAfterShape(this.lastShapeId, a)),
                            i && (b = d.drawLine(e[0], this.canvasTop, e[0], this.canvasTop + this.canvasHeight, i),
                    ...
                    processRangeOptions: function () {
                        ...
                        void 0 !== b && (b < this.miny && (this.miny = b),
                            c > this.maxy && (this.maxy = c)),
                            void 0 !== a.get("chartRangeMin") && (a.get("chartRangeClip") || a.get("chartRangeMin") < this.miny) && (this.miny = a.get("chartRangeMin")),
                            void 0 !== a.get("chartRangeMax") && (a.get("chartRangeClip") || a.get("chartRangeMax") > this.maxy) && (this.maxy = a.get("chartRangeMax")),
                            void 0 !== a.get("chartRangeMinX") && (a.get("chartRangeClipX") || a.get("chartRangeMinX") < this.minx) && (this.minx = a.get("chartRangeMinX")),
                            void 0 !== a.get("chartRangeMaxX") && (a.get("chartRangeClipX") || a.get("chartRangeMaxX") > this.maxx) && (this.maxx = a.get("chartRangeMaxX"))
                    },
                    ...
                    render: function () {
                        var a, d, e, f, g, h, i, j, k, l, m, n, o, p, r, s, t, v, w, x, y, z, A, B, C, D = this.options, E = this.target, F = this.canvasWidth, G = this.canvasHeight, H = this.vertices, I = D.get("spotRadius"), J = this.regionMap;
                        if (u._super.render.call(this) && (this.scanValues(),
                            ...
                            for (f = g = 0,
                                ...
                                I && (F < 4 * I || G < 4 * I) && (I = 0),
                                I && (y = D.get("highlightSpotColor") && !D.get("disableInteraction"),
                                    (y || D.get("minSpotColor") || D.get("spotColor") && B[e] === this.miny) && (G -= b.ceil(I)),
                                    (y || D.get("maxSpotColor") || D.get("spotColor") && B[e] === this.maxy) && (G -= b.ceil(I),
                                        f += b.ceil(I)),
                                    (y || (D.get("minSpotColor") || D.get("maxSpotColor")) && (B[0] === this.miny || B[0] === this.maxy)) && (g += b.ceil(I),
                                        F -= b.ceil(I)),
                                    (y || D.get("spotColor") || D.get("minSpotColor") || D.get("maxSpotColor") && (B[e] === this.miny || B[e] === this.maxy)) && (F -= b.ceil(I))),
                                G--,
                                void 0 === D.get("normalRangeMin") || D.get("drawNormalOnTop") || this.drawNormalRange(g, f, G, F, d),
                                i = [],
                                j = [i],
                                p = r = null,
                                s = B.length,
                                ...
                                k = A[C],
                                    ...
                                    J[C] = [p || 0, r, C],
                                    p = r,
                                    null === l ? C && (null !== B[C - 1] && (i = [],
                                        j.push(i)),
                                        H.push(null)) : (l < this.miny && (l = this.miny),
                            ...
                            for (t = [],
                                ...
                                C = 0; C < w; C++)
                                i = j[C],
                                    i.length && (D.get("fillColor") && (i.push([i[i.length - 1][0], f + G]),
                                        v.push(i.slice(0)),
                                        i.pop()),
                            ...
                            for (w = v.length,
                                C = 0; C < w; C++)
                                E.drawShape(v[C], D.get("fillColor"), D.get("fillColor")).append();
                            for (void 0 !== D.get("normalRangeMin") && D.get("drawNormalOnTop") && this.drawNormalRange(g, f, G, F, d),
                                w = t.length,
                                C = 0; C < w; C++)
                                E.drawShape(t[C], D.get("lineColor"), void 0, D.get("lineWidth")).append();
                            if (I && D.get("valueSpots"))
                                for (x = D.get("valueSpots"),
                                    void 0 === x.get && (x = new q(x)),
                                    C = 0; C < s; C++)
                                    (z = x.get(B[C])) && E.drawCircle(g + b.round((A[C] - this.minx) * (F / a)), f + b.round(G - G * ((B[C] - this.miny) / d)), I, void 0, z).append();
                            I && D.get("spotColor") && null !== B[e] && E.drawCircle(g + b.round((A[A.length - 1] - this.minx) * (F / a)), f + b.round(G - G * ((B[e] - this.miny) / d)), I, void 0, D.get("spotColor")).append(),
                                this.maxy !== this.minyorg && (I && D.get("minSpotColor") && (k = A[c.inArray(this.minyorg, B)],
                                    E.drawCircle(g + b.round((k - this.minx) * (F / a)), f + b.round(G - G * ((this.minyorg - this.miny) / d)), I, void 0, D.get("minSpotColor")).append()),
                                    I && D.get("maxSpotColor") && (k = A[c.inArray(this.maxyorg, B)],
                                        E.drawCircle(g + b.round((k - this.minx) * (F / a)), f + b.round(G - G * ((this.maxyorg - this.miny) / d)), I, void 0, D.get("maxSpotColor")).append())),
                ...
                c.fn.sparkline.bar = v = e(c.fn.sparkline._base, t, {
                    ...
                    init: function (a, d, e, f, h) {
                        var l, m, n, o, p, r, s, t, u, w, x, y, z, A, B, C, D, E, F, G, H, I, J = parseInt(e.get("barWidth"), 10), K = parseInt(e.get("barSpacing"), 10), L = e.get("chartRangeMin"), M = e.get("chartRangeMax"), N = e.get("chartRangeClip"), O = 1 / 0, P = -1 / 0;
                        for (v._super.init.call(this, a, d, e, f, h),
                            r = 0,
                            s = d.length; r < s; r++)
                            G = d[r],
                                ((l = "string" == typeof G && G.indexOf(":") > -1) || c.isArray(G)) && (B = !0,
                                    l && (G = d[r] = j(G.split(":"))),
                                    G = k(G, null),
                                    m = b.min.apply(b, G),
                                    n = b.max.apply(b, G),
                        ...
                        for (r = 0,
                            ...
                            if (B)
                                for (C = d[r],
                                    ...
                                    D = 0,
                                    E = C.length; D < E; D++)
                                    null !== (G = F[D] = N ? g(C[D], z, A) : C[D]) && (G > 0 && (Q[r] += G),
                                        O < 0 && P > 0 ? G < 0 ? R[r] += b.abs(G) : o[r] += G : o[r] += b.abs(G - (G < 0 ? P : O)),
                                        p.push(G));
                            else
                                G = N ? g(d[r], z, A) : d[r],
                        ...
                        this.max = y = b.max.apply(b, p),
                            ...
                            void 0 !== e.get("chartRangeMin") && (e.get("chartRangeClip") || e.get("chartRangeMin") < x) && (x = e.get("chartRangeMin")),
                            void 0 !== e.get("chartRangeMax") && (e.get("chartRangeClip") || e.get("chartRangeMax") > y) && (y = e.get("chartRangeMax")),
                            this.zeroAxis = u = e.get("zeroAxis", !0),
                            w = x <= 0 && y >= 0 && u ? 0 : 0 == u ? x : x > 0 ? x : y,
                            this.xaxisOffset = w,
                            t = B ? b.max.apply(b, o) + b.max.apply(b, R) : y - x,
                            this.canvasHeightEf = u && x < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1,
                            x < w ? (I = B && y >= 0 ? P : y,
                                (H = (I - w) / t * this.canvasHeight) !== b.ceil(H) && (this.canvasHeightEf -= 2,
                                    H = b.ceil(H))) : H = this.canvasHeight,
                            this.yoffset = H,
                            c.isArray(e.get("colorMap")) ? (this.colorMapByIndex = e.get("colorMap"),
                                this.colorMapByValue = null) : (this.colorMapByIndex = null,
                                    this.colorMapByValue = e.get("colorMap"),
                                    this.colorMapByValue && void 0 === this.colorMapByValue.get && (this.colorMapByValue = new q(this.colorMapByValue))),
                            this.range = t
                    },
                    ...
                    calcColor: function (a, b, d) {
                        ...
                        return e = this.stacked ? i.get("stackedBarColor") : b < 0 ? i.get("negBarColor") : i.get("barColor"),
                            0 === b && void 0 !== i.get("zeroColor") && (e = i.get("zeroColor")),
                            h && (f = h.get(b)) ? e = f : g && g.length > d && (e = g[d]),
                            c.isArray(e) ? e[a % e.length] : e
                    },
                    renderRegion: function (a, d) {
                        var e, f, g, h, i, j, k, l, n, o, p = this.values[a], q = this.options, r = this.xaxisOffset, s = [], t = this.range, u = this.stacked, v = this.target, w = a * this.totalBarWidth, x = this.canvasHeightEf, y = this.yoffset;
                        if (p = c.isArray(p) ? p : [p],
                            k = p.length,
                            l = p[0],
                            h = m(null, p),
                            o = m(r, p, !0),
                            h)
                            return q.get("nullColor") ? (g = d ? q.get("nullColor") : this.calcHighlightColor(q.get("nullColor"), q),
                                e = y > 0 ? y - 1 : y,
                                v.drawRect(w, e, this.barWidth - 1, 0, g, g)) : void 0;
                        for (i = y,
                            j = 0; j < k; j++) {
                            if (l = p[j],
                                u && l === r) {
                ...
                c.fn.sparkline.tristate = w = e(c.fn.sparkline._base, t, {
                    ...
                    init: function (a, b, d, e, f) {
                        ...
                        w._super.init.call(this, a, b, d, e, f),
                            ...
                            c.isArray(d.get("colorMap")) ? (this.colorMapByIndex = d.get("colorMap"),
                                this.colorMapByValue = null) : (this.colorMapByIndex = null,
                    ...
                    renderRegion: function (a, c) {
                        ...
                        if (d = l.pixelHeight,
                            ...
                            return c && (i = this.calcHighlightColor(i, k)),
                ...
                c.fn.sparkline.discrete = x = e(c.fn.sparkline._base, t, {
                    ...
                    init: function (a, d, e, f, g) {
                        x._super.init.call(this, a, d, e, f, g),
                            ...
                            this.width = f = "auto" === e.get("width") ? 2 * d.length : this.width,
                            this.interval = b.floor(f / d.length),
                            this.itemWidth = f / d.length,
                            void 0 !== e.get("chartRangeMin") && (e.get("chartRangeClip") || e.get("chartRangeMin") < this.min) && (this.min = e.get("chartRangeMin")),
                            void 0 !== e.get("chartRangeMax") && (e.get("chartRangeClip") || e.get("chartRangeMax") > this.max) && (this.max = e.get("chartRangeMax")),
                            this.initTarget(),
                            this.target && (this.lineHeight = "auto" === e.get("lineHeight") ? b.round(.3 * this.canvasHeight) : e.get("lineHeight"))
                    },
                    getRegion: function (a, c, d) {
                    ...
                    renderRegion: function (a, c) {
                        var d, e, f, h, i = this.values, j = this.options, k = this.min, l = this.max, m = this.range, n = this.interval, o = this.target, p = this.canvasHeight, q = this.lineHeight, r = p - q;
                        return e = g(i[a], k, l),
                            h = a * n,
                            d = b.round(r - r * ((e - k) / m)),
                ...
                c.fn.sparkline.pie = z = e(c.fn.sparkline._base, {
                    ...
                    renderSlice: function (a, c) {
                        var d, e, f, g, h, i = this.target, j = this.options, k = this.radius, l = j.get("borderWidth"), m = j.get("offset"), n = 2 * b.PI, o = this.values, p = this.total, q = m ? 2 * b.PI * (m / 360) : 0;
                        for (g = o.length,
                            f = 0; f < g; f++) {
                            if (d = q,
                                e = q,
                                p > 0 && (e = q + n * (o[f] / p)),
                                a === f)
                                return h = j.get("sliceColors")[f % j.get("sliceColors").length],
                    ...
                    render: function () {
                        ...
                        if (z._super.render.call(this)) {
                            for (h && d.drawCircle(g, g, b.floor(g - h / 2), f.get("borderColor"), void 0, h).append(),
                                c = e.length; c--;)
                                e[c] && (a = this.renderSlice(c).append(),
                ...
                c.fn.sparkline.box = A = e(c.fn.sparkline._base, {
                    ...
                    render: function () {
                        var a, c, d, e, f, g, i, j, k, l, m, n = this.target, o = this.values, p = o.length, q = this.options, r = this.canvasWidth, s = this.canvasHeight, t = void 0 === q.get("chartRangeMin") ? b.min.apply(b, o) : q.get("chartRangeMin"), u = void 0 === q.get("chartRangeMax") ? b.max.apply(b, o) : q.get("chartRangeMax"), v = 0;
                        if (A._super.render.call(this)) {
                            if (q.get("raw"))
                                q.get("showOutliers") && o.length > 5 ? (c = o[0],
                                    a = o[1],
                                    e = o[2],
                                    f = o[3],
                                    g = o[4],
                                ...
                                for (a = i = void 0,
                                    k = 0; k < p; k++)
                                    void 0 === a && o[k] > e - d * q.get("outlierIQR") && (a = o[k]),
                            ...
                            this.quartiles = [e, f, g],
                                ...
                                this.routlier = j,
                                m = r / (u - t + 1),
                                q.get("showOutliers") && (v = b.ceil(q.get("spotRadius")),
                                    r -= 2 * b.ceil(q.get("spotRadius")),
                                    m = r / (u - t + 1),
                                    c < a && n.drawCircle((c - t) * m + v, s / 2, q.get("spotRadius"), q.get("outlierLineColor"), q.get("outlierFillColor")).append(),
                                    j > i && n.drawCircle((j - t) * m + v, s / 2, q.get("spotRadius"), q.get("outlierLineColor"), q.get("outlierFillColor")).append()),
                                n.drawRect(b.round((e - t) * m + v), b.round(.1 * s), b.round((g - e) * m), b.round(.8 * s), q.get("boxLineColor"), q.get("boxFillColor")).append(),
                                n.drawLine(b.round((a - t) * m + v), b.round(s / 2), b.round((e - t) * m + v), b.round(s / 2), q.get("lineColor")).append(),
                                n.drawLine(b.round((a - t) * m + v), b.round(s / 4), b.round((a - t) * m + v), b.round(s - s / 4), q.get("whiskerColor")).append(),
                                n.drawLine(b.round((i - t) * m + v), b.round(s / 2), b.round((g - t) * m + v), b.round(s / 2), q.get("lineColor")).append(),
                                n.drawLine(b.round((i - t) * m + v), b.round(s / 4), b.round((i - t) * m + v), b.round(s - s / 4), q.get("whiskerColor")).append(),
                                n.drawLine(b.round((f - t) * m + v), b.round(.1 * s), b.round((f - t) * m + v), b.round(.9 * s), q.get("medianColor")).append(),
                                q.get("target") && (l = b.ceil(q.get("spotRadius")),
                                    n.drawLine(b.round((q.get("target") - t) * m + v), b.round(s / 2 - l), b.round((q.get("target") - t) * m + v), b.round(s / 2 + l), q.get("targetColor")).append(),
                                    n.drawLine(b.round((q.get("target") - t) * m + v - l), b.round(s / 2), b.round((q.get("target") - t) * m + v + l), b.round(s / 2), q.get("targetColor")).append()),
                                n.render()
                        }
                    }
                }),
                ...
                F = e(E, {
                    ...
                    _getContext: function (a, b, c) {
                        ...
                        return void 0 !== a && (d.strokeStyle = a),
                    ...
                    _drawShape: function (a, b, c, d, e) {
                        ...
                        for (h.beginPath(),
                            h.moveTo(b[0][0] + .5, b[0][1] + .5),
                            f = 1,
                            g = b.length; f < g; f++)
                            h.lineTo(b[f][0] + .5, b[f][1] + .5);
                        void 0 !== c && h.stroke(),
                            void 0 !== d && h.fill(),
                            void 0 !== this.targetX && void 0 !== this.targetY && h.isPointInPath(this.targetX, this.targetY) && (this.currentTargetShapeId = a)
                    },
                    _drawCircle: function (a, c, d, e, f, g, h) {
                        var i = this._getContext(f, g, h);
                        i.beginPath(),
                            i.arc(c, d, e, 0, 2 * b.PI, !1),
                            void 0 !== this.targetX && void 0 !== this.targetY && i.isPointInPath(this.targetX, this.targetY) && (this.currentTargetShapeId = a),
                            void 0 !== f && i.stroke(),
                            void 0 !== g && i.fill()
                    },
                ...
                G = e(E, {
                    ...
                    _drawShape: function (a, b, c, d, e) {
                        ...
                        for (k = 0,
                            j = b.length; k < j; k++)
                            l[k] = b[k][0] + "," + b[k][1];
                        return f = l.splice(0, 1),
                            e = void 0 === e ? 1 : e,
                            g = void 0 === c ? ' stroked="false" ' : ' strokeWeight="' + e + 'px" strokeColor="' + c + '" ',
                            h = void 0 === d ? ' filled="false"' : ' fillColor="' + d + '" filled="true" ',
                            i = l[0] === l[l.length - 1] ? "x " : "",
                            '<v:shape coordorigin="0 0" coordsize="' + this.pixelWidth + " " + this.pixelHeight + '"  id="jqsshape' + a + '" ' + g + h + ' style="position:absolute;left:0px;top:0px;height:' + this.pixelHeight + "px;width:" + this.pixelWidth + 'px;padding:0px;margin:0px;"  path="m ' + f + " l " + l.join(", ") + " " + i + 'e"> </v:shape>'
                    },
                    _drawCircle: function (a, b, c, d, e, f, g) {
                        var h, i;
                        return b -= d,
                            c -= d,
                            h = void 0 === e ? ' stroked="false" ' : ' strokeWeight="' + g + 'px" strokeColor="' + e + '" ',
                            i = void 0 === f ? ' filled="false"' : ' fillColor="' + f + '" filled="true" ',
                            '<v:oval  id="jqsshape' + a + '" ' + h + i + ' style="position:absolute;top:' + c + "px; left:" + b + "px; width:" + 2 * d + "px; height:" + 2 * d + 'px"></v:oval>'
                    },
                    _drawPieSlice: function (a, c, d, e, f, g, h, i) {
                        ...
                        return k === m && l === n && g - f < b.PI ? "" : (j = [c - e, d - e, c + e, d + e, k, l, m, n],
                            o = void 0 === h ? ' stroked="false" ' : ' strokeWeight="1px" strokeColor="' + h + '" ',
                            p = void 0 === i ? ' filled="false"' : ' fillColor="' + i + '" filled="true" ',
                            '<v:shape coordorigin="0 0" coordsize="' + this.pixelWidth + " " + this.pixelHeight + '"  id="jqsshape' + a + '" ' + o + p + ' style="position:absolute;left:0px;top:0px;height:' + this.pixelHeight + "px;width:" + this.pixelWidth + 'px;padding:0px;margin:0px;"  path="m ' + c + "," + d + " wa " + j.join(", ") + ' x e"> </v:shape>')
                    },
                    _drawRect: function (a, b, c, d, e, f, g) {
