!function (t, e) {
    ...
    function ot(t, e) {
        var n = 1 < arguments.length && void 0 !== e && e
            , o = L();
        pt(o) && (n && (o.style.transition = "none",
            o.style.width = "100%"),
            setTimeout(function () {
    ...
    var st, ut = function (t, e) {
        ...
        var e, n = !!(e = W()) && (e.parentNode.removeChild(e),
            lt([document.documentElement, document.body], [F["no-backdrop"], F["toast-shown"], F["has-column"]]),
            !0);
        if (it())
    ...
    function bt(t, e, n) {
        var o;
        et(t, n["show".concat((o = e).charAt(0).toUpperCase() + o.slice(1), "Button")], "inline-block"),
    ...
    function yt(t, e) {
        ...
        if (n) {
            var o, i, r, a;
            o = n,
                "string" == typeof (i = e.backdrop) ? o.style.background = i : i || ut([document.documentElement, document.body], F["no-backdrop"]),
                !e.backdrop && e.allowOutsideClick && D('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
                r = n,
                (a = e.position) in F ? ut(r, F[a]) : (D('The "position" parameter is not valid, defaulting to "center"'),
                    ut(r, F.center)),
                function (t, e) {
    ...
    St.text = St.email = St.password = St.number = St.tel = St.url = function (t, e) {
        return "string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : g(e.inputValue) || D('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')),
            wt(t, e),
            t.type = e.input,
            t
    }
    ...
    function Et(t, e) {
        ...
        e.html ? (at(e.html, c),
            G(c, "block")) : e.text ? (c.textContent = e.text,
                G(c, "block")) : tt(c),
            n = t,
            o = e,
            i = k(),
    ...
    function Tt(t, s) {
        ...
        l >= s.progressSteps.length && D("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
    ...
    var jt = function () {
        ...
        , Ht = []
        , Dt = function (t, e) {
            t.className = "".concat(F.popup, " ").concat(pt(t) ? e.showClass.popup : ""),
                e.toast ? (ut([document.documentElement, document.body], F["toast-shown"]),
                    ut(t, F.toast)) : ut(t, F.modal),
                R(t, e, "popup"),
        ...
        , Jt = Object.freeze({
            ...
            queue: function (t) {
                ...
                return new Promise(function (i) {
                    !function e(n, o) {
                        n < Ht.length ? (document.body.setAttribute("data-swal2-queue-step", n),
    ...
    function Xt() {
        ...
        if (t) {
            ...
            t.showConfirmButton || (tt(e.confirmButton),
                t.showCancelButton || tt(e.actions)),
    ...
    function Gt() {
        null === Z.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (Z.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")),
    ...
    function ie(t, e, n, o) {
        n ? ce(t, o) : (Ut().then(function () {
            ...
            j() && (null !== Z.previousBodyPadding && (document.body.style.paddingRight = "".concat(Z.previousBodyPadding, "px"),
                ...
                "undefined" != typeof window && te() && window.removeEventListener("resize", ee),
    ...
    function re(t) {
        ...
        if (e) {
            ...
            if (n && !V(e, n.hideClass.popup)) {
                ...
                lt(e, n.showClass.popup),
                    ut(e, n.hideClass.popup);
                var i = W();
    ...
    function pe(t) {
        ...
        (e = t).inputValidator || Object.keys(de).forEach(function (t) {
            ...
            (n = t).target && ("string" != typeof n.target || document.querySelector(n.target)) && ("string" == typeof n.target || n.target.appendChild) || (D('Target parameter is not valid, defaulting to "body"'),
                n.target = "body"),
    ...
    function Ce(t, e, n) {
        Ct.innerParams.get(t).toast ? Ue(t, e, n) : (Fe(e),
            ze(e),
            We(t, e, n))
    }
    var ke = function (t, e) {
        vt && nt(e) ? (t.style.overflowY = "hidden",
            e.addEventListener(vt, me)) : t.style.overflowY = "auto"
    }
        , xe = function (t, e) {
            !function () {
                ...
                "undefined" != typeof window && te() && (ee(),
                    window.addEventListener("resize", ee)),
                m(document.body.children).forEach(function (t) {
                    t === W() || function (t, e) {
                        if ("function" == typeof t.contains)
                            return t.contains(e)
                    }(t, W()) || (t.hasAttribute("aria-hidden") && t.setAttribute("data-previous-aria-hidden", t.getAttribute("aria-hidden")),
        ...
        , Pe = function (t, e, n) {
            ut(t, n.showClass.backdrop),
                ...
                n.heightAuto && n.backdrop && !n.toast && ut([document.documentElement, document.body], F["height-auto"])
        }
        , Ae = function (t) {
        ...
        , qe = function (e, n) {
            ...
            n.inputValidator ? (e.disableInput(),
                ...
                })) : e.getInput().checkValidity() ? Ie(e, n, o) : (e.enableButtons(),
        ...
        , Ve = function (t, e, n) {
            ...
            o.stopKeydownPropagation && e.stopPropagation(),
                "Enter" === e.key ? Re(t, e, o) : "Tab" === e.key ? He(e, o) : -1 !== je.indexOf(e.key) ? De() : -1 !== Me.indexOf(e.key) && Ne(e, o, n)
        }
        , Re = function (t, e, n) {
        ...
        , Ne = function (t, e, n) {
            U(e.allowEscapeKey) && (t.preventDefault(),
                n(_.esc))
        }
        , Ue = function (e, t, n) {
    ...
    var Ke = function (t, e, n) {
        ...
        , Ye = function (t, e) {
            if (!e.toast)
                return U(e.allowEnterKey) ? e.focusCancel && pt(t.cancelButton) ? t.cancelButton.focus() : e.focusConfirm && pt(t.confirmButton) ? t.confirmButton.focus() : void we(0, -1, 1) : Ze()
        }
        , Ze = function () {
            ...
            !function (t) {
                for (var e in t)
                    zt(i = e) || D('Unknown parameter "'.concat(i, '"')),
                        t.toast && (o = e,
                            -1 !== $t.indexOf(o) && D('The parameter "'.concat(o, '" is incompatible with toasts'))),
                        Wt(n = e) && h(n, Wt(n));
                var n, o, i
            }(t),
    ...
    Xe.prototype.then = function (t) {
        ...
        Object.keys(Je).forEach(function (t) {
            Xe[t] = function () {
                if (Qe)
                    return Qe[t].apply(Qe, arguments)
            }
        }),
        Xe.DismissReason = _,
        Xe.version = "9.10.8";
    ...
    0 !== e._state ? (e._handled = !0,
        Promise._immediateFn(function () {
            ...
            if (null !== t) {
                ...
                (1 === e._state ? resolve : reject)(n.promise, e._value)
        })) : e._deferreds.push(n)
}
    ...
    try {
        ...
        if (n && ("object" == typeof n || "function" == typeof n)) {
            ...
            if ("function" == typeof t)
                return void doResolve(bind(t, n), e)
        }
        e._state = 1,
            e._value = n,
            finale(e)
...
Promise.prototype.catch = function (e) {
    ...
    Promise.prototype.then = function (e, n) {
        ...
        return handle(this, new Handler(e, n, t)),
            t
    }
    ,
                ...
                try {
                    if (s && ("object" == typeof s || "function" == typeof s)) {
                        ...
                        if ("function" == typeof c)
                            return void c.call(s, function (n) {
                                i(e, n)
                            }, t)
                    }
                    r[e] = s,
